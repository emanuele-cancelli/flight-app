...
public class FlightDto {
	 ...
	 * @return the conforts
	 */
	public Set<String> getConforts() {
		return conforts;
	}
	/**
	 * @param conforts the conforts to set
	 */
	public void setConforts(Set<String> conforts) {
	...
	public FlightDto(Long idFlight, CompanyName companyName, FlightType flightType, TravelType travelType,
			...
			Set<String> conforts, Set<InflightInfo> inflightInfo) {
		super();
		this.idFlight = idFlight;
		this.companyName = companyName;
		this.flightType = flightType;
